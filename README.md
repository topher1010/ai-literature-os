...
| **`claude-code-skills/`** | The Claude Code skills in use (`/science-search`, `/deep-synthesis`, `/add-papers`). Forked context keeps large search results out of the main session. | Drop-in if you use Claude Code; otherwise a worked example of how an agent might use the vault. |
